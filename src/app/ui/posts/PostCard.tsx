...
export default function PostCard({ post }: { post: PostType }) {
    return (
        <div className="h-full py-2 px-4 w-full rounded-lg bg-white shadow-xl flex flex-col gap-3">
            ...
            <p className="text-sm font-bold">{post.body.length >= 25 ? post.body.slice(0, 25) + "..." : post.body}.</p>
